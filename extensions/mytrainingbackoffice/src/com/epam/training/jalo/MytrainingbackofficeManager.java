...
import com.epam.training.constants.MytrainingbackofficeConstants;
 ...
 */
public class MytrainingbackofficeManager extends GeneratedMytrainingbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MytrainingbackofficeManager.class.getName());
	 ...
	 */
	public static MytrainingbackofficeManager getInstance()
	{
		return (MytrainingbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MytrainingbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MytrainingbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MytrainingbackofficeManager called.");
		}
	}
