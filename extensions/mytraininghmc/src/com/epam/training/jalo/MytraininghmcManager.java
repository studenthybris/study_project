...
import com.epam.training.constants.MytraininghmcConstants;



/**
 * This is the extension manager of the Mytraininghmc extension.
 */
public class MytraininghmcManager extends GeneratedMytraininghmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MytraininghmcManager.class.getName());
	 ...
	 */
	public static MytraininghmcManager getInstance()
	{
		return (MytraininghmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MytraininghmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MytraininghmcManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MytraininghmcManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MytraininghmcManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MytraininghmcManager called, current tenant: " + getTenant().getTenantID());
		}
	}
