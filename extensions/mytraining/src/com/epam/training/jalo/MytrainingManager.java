...
/**
 * This is the extension manager of the Mytraining extension.
 */
public class MytrainingManager extends GeneratedMytrainingManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MytrainingManager.class.getName());
	 ...
	 */
	public static MytrainingManager getInstance()
	{
		return (MytrainingManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MytrainingConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MytrainingManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MytrainingManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MytrainingManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MytrainingManager called, current tenant: " + getTenant().getTenantID());
		}
	}
