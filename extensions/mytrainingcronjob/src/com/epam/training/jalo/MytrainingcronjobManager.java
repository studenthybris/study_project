...
/**
 * This is the extension manager of the Mytrainingcronjob extension.
 */
public class MytrainingcronjobManager extends GeneratedMytrainingcronjobManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MytrainingcronjobManager.class.getName());
	 ...
	 */
	public static MytrainingcronjobManager getInstance()
	{
		return (MytrainingcronjobManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MytrainingcronjobConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MytrainingcronjobManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MytrainingcronjobManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MytrainingcronjobManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MytrainingcronjobManager called, current tenant: " + getTenant().getTenantID());
		}
	}
